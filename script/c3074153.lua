...
function s.spellconfilter(c)
    return (c:IsType(TYPE_SPELL+TYPE_TRAP) and c:IsType(TYPE_CONTINUOUS)) and c:IsFaceup() and c:IsSetCard(0x6e)
end
...
Attribute: TRAP
Type: [Trap/Normal]
Card Text: Activate 1 of the following effects:
           ● If you control a face-up "Intergalactic" monster: You can banish 1 "Intergalactic" card from your hand, then target 1 face-up monster your
           opponent controls; destroy it.
           ● If you control a face-up "Intergalactic" Continuous Spell/Trap: You can banish 1 "Intergalactic" card from your hand, then target up to 2
           Spells/Traps your opponent controls; destroy them.
           During your Main Phase: You can return this banished card to the GY; add 1 "Intergalactic" card from your Deck to your hand, except
           "Intergalactic Meteors". You can only use each effect of "Intergalactic Meteors" once per turn.
Card ID: 03074153
--]]
