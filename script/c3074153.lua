...
function s.setcon(e,tp,eg,ep,ev,re,r,rp)
    return e:GetHandler():IsReason(REASON_DESTROY) and rp==1-tp and c:IsReason(REASON_EFFECT)
end
...
Card Text: Banish 1 "Intergalactic" card from your hand; Activate 1 of the effects based on the face up "Intergalactic" cards you control.
           ...
           ● Spell/Trap: Target up to 2 Spells/Traps your opponent controls; destroy them.
