...
function s.filter(c,e,tp)
    return c:IsSetCard(0x584) and c:IsCanBeSpecialSummoned(e,0,tp,true,false) and c:IsMonster()
end
...
Card Text: Special Summon 1 "Lord of the Banished Realm" monster from your hand, but its effects are negated until the End
           Phase. You can only use this effect of "Banished Enchantment, Guidance" once per turn. During your Main Phase:
           You can return this banished card to the GY and target 1 face-up monster your opponent controls; banish it.
Card ID: 03218898
--]]
